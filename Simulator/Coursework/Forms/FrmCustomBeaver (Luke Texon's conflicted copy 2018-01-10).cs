...
namespace Coursework
{
    public partial class FrmCustomBeaver : Form
    {
        ...
        /// <summary>
        /// Open and pass states to ExecuteBeaver form 
        /// </summary>
        ...
        {                       
            ...
            if (dB.ValidateBeaver(States))
            {
                //Open ExecuteBeaver form and close this form                  
                (new FrmExecuteBeaver(States, trbSpeed.Value, chkDeteRecur.Checked)).Show();
                this.Close();
        ...
        private void FrmCustomBeaver_Load(object sender, EventArgs e)
        {
